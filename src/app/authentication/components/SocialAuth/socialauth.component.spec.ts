...
import { AuthLayoutRoutes } from 'src/app/authentication/authentication.routing';
...
describe('SocialLoginComponentt', () => {
	...
	it('should be able to sign with google', () => {
		let authdata = authServiceSpy.signIn.and.returnValue(new Promise((resolve) => resolve(userData)));

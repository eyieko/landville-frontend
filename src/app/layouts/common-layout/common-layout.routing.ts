...
export const CommonLayoutRoutes: Routes = [
  {
    ...
    data: {
      title:
        'LandVille helps you access real estate and property investing in Nigeria.' +
  ...
  },
  {
    ...
    data: {
      title: 'All Properties | Acquire your dream property with ease today',
      tags: [
        // Open Graph Data
        {
          property: 'og:title',
          content:
            'All Properties | Acquire your dream property with ease today'
        },
        {
          property: 'og:description',
